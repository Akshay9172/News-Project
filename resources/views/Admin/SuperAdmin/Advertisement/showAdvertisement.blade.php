                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="advertisement_type" class="form-select" onchange="this.form.submit()">
                                ...
                                <option value="Home Right Side" {{ request('advertisement_type') == 'Home Right Side' ? 'selected' : '' }}>
                                    Home Right Side
                                </option>
                                <option value="Breaking News Bottom" {{ request('advertisement_type') == 'Breaking News Bottom' ? 'selected' : '' }}>
                                    Breaking News Bottom
                                </option>
                                <option value="Single News Page" {{ request('advertisement_type') == 'Single News Page' ? 'selected' : '' }}>
                                    Single News Page
                                </option>
                            </select>
                        </div>
                    ...
                    <tbody>
                        @foreach ($advertisements as $key => $item)
                            <tr>
                                ...
                                <td><img src="{{ asset('storage/images/' . $item->img) }}" style="width: 100px; height: auto;"></td>
